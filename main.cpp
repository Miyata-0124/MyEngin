...
// レンダーターゲットビューのハンドルを取得
		...
		viewport[0].Width = 640;
		viewport[0].Height = 360;
		viewport[0].TopLeftX = 0;
		viewport[0].TopLeftY = 0;
		viewport[0].MinDepth = 0.0f;
		viewport[0].MaxDepth = 1.0f;

		viewport[1].Width = 640;
		viewport[1].Height = 360;
		viewport[1].TopLeftX = 640;
		viewport[1].TopLeftY = 0;
		viewport[1].MinDepth = 0.0f;
		viewport[1].MaxDepth = 1.0f;

		viewport[2].Width = 640;
		viewport[2].Height = 360;
		viewport[2].TopLeftX = 0;
		viewport[2].TopLeftY = 360;
		viewport[2].MinDepth = 0.0f;
		viewport[2].MaxDepth = 1.0f;

		viewport[3].Width = 640;
		viewport[3].Height = 360;
		viewport[3].TopLeftX = 640;
		viewport[3].TopLeftY = 360;

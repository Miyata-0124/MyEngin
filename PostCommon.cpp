...
std::string PostCommon::defaultTextureDirectoryPath = "Resources/";

void PostCommon::Initialize(DirectXCommon* directXCom_)
{
...
void PostCommon::Loadtexture(uint32_t index, std::string fileName)
{
...
void PostCommon::PostDraw(){}

void PostCommon::SetTextureCommands(uint32_t index)
{
	comList = directXCom->GetCommandList();
	// パイプラインステートとルートシグネチャの設定コマンド
	comList->SetPipelineState(pipelineState);

...
/// 静的メンバ変数の実体
/// </summary>
const float Particle::radius = 5.0f;				// 半径
const float Particle::prizmHeight = 8.0f;			// 高さ
...
void Particle::StaticInitialize(ID3D12Device* device, int window_width, int window_height)
{
	// nullptrチェック
	assert(device);
...
Particle* Particle::Create()
{
	...
	//スケールをセット
	float	scele_val = 20;
	particle->scale = { scele_val,scele_val, scele_val };
